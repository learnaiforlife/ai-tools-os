...
The current views all use one native resource inventory and the private Electron request channel. The resolution register in `docs/fixes-2026-09-09/RESOLUTION.md` distinguishes working functionality from retired prototypes. Tests and lint target the active implementation; archived review probes describe the earlier snapshot, not current expected behavior.

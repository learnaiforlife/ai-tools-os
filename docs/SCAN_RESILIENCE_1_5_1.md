...
| An unrelated broken root prevents a healthy edit | Authorization ignores unresolvable roots as grants of access, then checks the healthy file against the remaining canonical roots. It never authorizes a lexical substitute for a broken link. |
